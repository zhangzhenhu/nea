...
parser.add_argument("-u", "--rec-unit", dest="recurrent_unit", type=str, metavar='<str>', default='lstm',
...
parser.add_argument("-c", "--cnndim", dest="cnn_dim", type=int, metavar='<int>', default=0,
...
(train_x, train_y, train_pmt, train_essay_ids), (dev_x, dev_y, dev_pmt, dev_essay_ids), (
    test_x, test_y, test_pmt, test_essay_ids), vocab, vocab_size, overal_maxlen, num_outputs = dataset.get_data(
...
evl = Evaluator(dataset, args.prompt_id, out_dir, dev_x, test_x, dev_y, test_y, dev_y_org, test_y_org, dev_essay_ids,
                test_essay_ids)
