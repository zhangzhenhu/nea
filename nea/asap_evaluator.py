...
class Evaluator():
    ...
    def __init__(self, dataset, prompt_id, out_dir, dev_x, test_x, dev_y, test_y, dev_y_org, test_y_org,dev_essay_ids,test_essay_ids):
        ...
        self.dev_essay_ids = dev_essay_ids
        self.test_essay_ids = test_essay_ids
